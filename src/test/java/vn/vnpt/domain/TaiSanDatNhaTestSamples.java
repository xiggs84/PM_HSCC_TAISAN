...
public class TaiSanDatNhaTestSamples {

    private static final Random random = new Random();
    private static final AtomicLong longCount = new AtomicLong(random.nextInt() + (2 * Integer.MAX_VALUE));

    public static TaiSanDatNha getTaiSanDatNhaSample1() {
        return new TaiSanDatNha()
            .id(1L)
            .idTaiSan(1L)
    ...
    public static TaiSanDatNha getTaiSanDatNhaSample2() {
        return new TaiSanDatNha()
            .id(2L)
            .idTaiSan(2L)
    ...
    public static TaiSanDatNha getTaiSanDatNhaRandomSampleGenerator() {
        return new TaiSanDatNha()
