...
public class SoHuuTheoResource {
    ...
    public SoHuuTheoResource(SoHuuTheoService soHuuTheoService, SoHuuTheoRepository soHuuTheoRepository) {
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<SoHuuTheoDTO>> getAllSoHuuTheos(@org.springdoc.core.annotations.ParameterObject Pageable pageable) {
        log.debug("REST request to get a page of SoHuuTheos");
        Page<SoHuuTheoDTO> page = soHuuTheoService.findAll(pageable);
