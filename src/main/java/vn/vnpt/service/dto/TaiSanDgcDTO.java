...
/**
 * A DTO for the {@link vn.vnpt.domain.TaiSanDgc} entity.
 */
@SuppressWarnings("common-java:DuplicatedBlocks")
public class TaiSanDgcDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TaiSanDgcDTO)) {
            return false;
        }

        TaiSanDgcDTO taiSanDgcDTO = (TaiSanDgcDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, taiSanDgcDTO.id);
    }
