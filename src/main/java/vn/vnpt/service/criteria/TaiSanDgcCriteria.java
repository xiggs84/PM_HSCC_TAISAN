...
/**
 * Criteria class for the {@link vn.vnpt.domain.TaiSanDgc} entity. This class is used
 * in {@link vn.vnpt.web.rest.TaiSanDgcResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /tai-san-dgcs?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class TaiSanDgcCriteria implements Serializable, Criteria {
    ...
    public TaiSanDgcCriteria() {}

    public TaiSanDgcCriteria(TaiSanDgcCriteria other) {
    ...
    @Override
    public TaiSanDgcCriteria copy() {
        return new TaiSanDgcCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final TaiSanDgcCriteria that = (TaiSanDgcCriteria) o;
        return (
