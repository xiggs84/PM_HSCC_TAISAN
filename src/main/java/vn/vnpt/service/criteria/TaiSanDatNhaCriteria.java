...
/**
 * Criteria class for the {@link vn.vnpt.domain.TaiSanDatNha} entity. This class is used
 * in {@link vn.vnpt.web.rest.TaiSanDatNhaResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /tai-san-dat-nhas?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class TaiSanDatNhaCriteria implements Serializable, Criteria {
    ...
    public TaiSanDatNhaCriteria() {}

    public TaiSanDatNhaCriteria(TaiSanDatNhaCriteria other) {
    ...
    @Override
    public TaiSanDatNhaCriteria copy() {
        return new TaiSanDatNhaCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final TaiSanDatNhaCriteria that = (TaiSanDatNhaCriteria) o;
        return (
