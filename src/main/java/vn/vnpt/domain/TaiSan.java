...
public class TaiSan implements Serializable {
    ...
    @JoinTable(
        name = "rel_tai_san__id_ts_goc",
        joinColumns = @JoinColumn(name = "tai_san_id"),
        inverseJoinColumns = @JoinColumn(name = "id_ts_goc_id")
    )
    @Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
    @JsonIgnoreProperties(value = { "idTsGocs", "idLoaiTs", "idTinhTrang", "taiSans", "taiSanDuongSu" }, allowSetters = true)
    private Set<TaiSan> idTsGocs = new HashSet<>();
    ...
    @ManyToOne(fetch = FetchType.LAZY)
    @JsonIgnoreProperties(value = { "taiSans" }, allowSetters = true)
    private TinhTrangTaiSan idTinhTrang;

    @ManyToMany(fetch = FetchType.LAZY, mappedBy = "idTsGocs")
    @Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
    @JsonIgnoreProperties(value = { "idTsGocs", "idLoaiTs", "idTinhTrang", "taiSans", "taiSanDuongSu" }, allowSetters = true)
    private Set<TaiSan> taiSans = new HashSet<>();

    @JsonIgnoreProperties(value = { "idTaiSan" }, allowSetters = true)
    @OneToOne(fetch = FetchType.LAZY, mappedBy = "idTaiSan")
    ...
    public Set<TaiSan> getIdTsGocs() {
        return this.idTsGocs;
    }

    public void setIdTsGocs(Set<TaiSan> taiSans) {
        this.idTsGocs = taiSans;
    }

    public TaiSan idTsGocs(Set<TaiSan> taiSans) {
        this.setIdTsGocs(taiSans);
        return this;
    }

    public TaiSan addIdTsGoc(TaiSan taiSan) {
        this.idTsGocs.add(taiSan);
        return this;
    }

    public TaiSan removeIdTsGoc(TaiSan taiSan) {
        this.idTsGocs.remove(taiSan);
        return this;
    }
    ...
    public TaiSan idLoaiTs(DanhMucLoaiTaiSan danhMucLoaiTaiSan) {
        this.setIdLoaiTs(danhMucLoaiTaiSan);
        return this;
    }

    public TinhTrangTaiSan getIdTinhTrang() {
        return this.idTinhTrang;
    }

    public void setIdTinhTrang(TinhTrangTaiSan tinhTrangTaiSan) {
        this.idTinhTrang = tinhTrangTaiSan;
    }

    public TaiSan idTinhTrang(TinhTrangTaiSan tinhTrangTaiSan) {
        this.setIdTinhTrang(tinhTrangTaiSan);
        return this;
    }
    ...
    public void setTaiSans(Set<TaiSan> taiSans) {
        if (this.taiSans != null) {
            this.taiSans.forEach(i -> i.removeIdTsGoc(this));
        }
        if (taiSans != null) {
            taiSans.forEach(i -> i.addIdTsGoc(this));
        }
        this.taiSans = taiSans;
    }

    public TaiSan taiSans(Set<TaiSan> taiSans) {
        this.setTaiSans(taiSans);
        return this;
    }

    public TaiSan addTaiSan(TaiSan taiSan) {
        this.taiSans.add(taiSan);
        taiSan.getIdTsGocs().add(this);
        return this;
    }

    public TaiSan removeTaiSan(TaiSan taiSan) {
        this.taiSans.remove(taiSan);
        taiSan.getIdTsGocs().remove(this);
        return this;
    }

    public TaiSanDuongSu getTaiSanDuongSu() {
        return this.taiSanDuongSu;
    }

    public void setTaiSanDuongSu(TaiSanDuongSu taiSanDuongSu) {
        if (this.taiSanDuongSu != null) {
            this.taiSanDuongSu.setIdTaiSan(null);
        }
        if (taiSanDuongSu != null) {
            taiSanDuongSu.setIdTaiSan(this);
        }
        this.taiSanDuongSu = taiSanDuongSu;
    }

    public TaiSan taiSanDuongSu(TaiSanDuongSu taiSanDuongSu) {
        this.setTaiSanDuongSu(taiSanDuongSu);
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        return getId() != null && getId().equals(((TaiSan) o).getId());
    }
